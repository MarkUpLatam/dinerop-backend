...
public class SolicitarGaranteUseCase {

    private final OnboardingService service;

    public SolicitudOnboarding execute(Long solicitudId, Long cooperativaId) {
        return service.solicitarGarante(solicitudId, cooperativaId);
    }
}
